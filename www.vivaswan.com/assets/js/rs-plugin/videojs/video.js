...
(function() {
    ...
    u.d = function(a, c, d) {
        ...
        e.W || (e.disabled = l, e.W = function(c) {
            if (!e.disabled) {
                ...
                var d = e.z[c.type];
                if (d)
                    for (var d = d.slice(0), k = 0, r = d.length; k < r && !c.lc(); k++) d[k].call(a, c)
            }
        });
    ...
    u.k.fc = function(a, c) {
        var d, e, g;
        a = u.k.copy(a);
        for (d in c) w.call(c, d) && (e = a[d], g = c[d], a[d] = u.k.mc(e) && u.k.mc(g) ? u.k.fc(e, g) : c[d]);
        return a
    };
    u.k.copy = function(a) {
        return u.k.B({}, a)
    ...
    t.Z = function(a, c) {
        ...
        "function" === typeof d.el && d.el() && (this.ra || this.a).appendChild(d.el());
        return d
    };
    t.removeChild = function(a) {
        ...
        if (a && this.H) {
            ...
            c && (this.pb[a.id] = j, this.V[a.name] = j, (c = a.v()) && c.parentNode === (this.ra || this.a) && (this.ra || this.a).removeChild(a.v()))
        }
    };
    t.T = q("");
    t.d = function(a, c) {
    ...
    t.M = function(a) {
        a && (this.aa ? a.call(this) : (this.Ra === b && (this.Ra = []), this.Ra.push(a)));
        return this
    };
    t.Ta = function() {
        this.aa = f;
    ...
    function F(a, c) {
        ...
        h = g = d.offsetWidth;
        d = a.handle;
        if (a.g.zd) return h = e.top, e = c.changedTouches ? c.changedTouches[0].pageY : c.pageY, d && (d = d.v().offsetHeight, h += d / 2, g -= d), Math.max(0, Math.min(1, (h - e + g) / g));
        g = e.left;
    ...
    u.N.prototype.selected = function(a) {
        a ? (this.m("vjs-selected"), this.a.setAttribute("aria-selected", f)) : (this.t("vjs-selected"), this.a.setAttribute("aria-selected", l))
    };
    u.R = u.q.extend({
        i: function(a, c) {
            u.q.call(this, a, c);
    ...
    t.ba = function(a) {
        a.preventDefault();
        32 == a.which || 13 == a.which ? this.oa ? G(this) : H(this) : 27 == a.which && this.oa && G(this)
    };
    ...
    u.w = u.c.extend({
        i: function(a, c, d) {
            ...
            u.wa[this.Q] = this;
            c.plugins && u.k.ta(c.plugins, function(a, c) {
                this[a](c)
            }, this);
            var e, g, h, k;
            e = this.rc;
            ...
            h = setInterval(u.bind(this, function() {
                this.ja &&
                    (this.ja = l, I(this, f), clearTimeout(k), k = setTimeout(u.bind(this, function() {
                        this.ja || I(this, l)
                    }), 2E3))
            }), 250);
    ...
    function da(a) {
        ...
        if (a.hasChildNodes()) {
            ...
            a = a.childNodes;
            g = 0;
            for (h = a.length; g < h; g++) d = a[g], e = d.nodeName.toLowerCase(), "source" === e ? c.sources.push(u.wb(d)) : "track" === e && c.tracks.push(u.wb(d))
        }
        return c
    }
    t.e = function() {
        ...
        if (c.hasChildNodes()) {
            ...
            d = c.childNodes;
            e = d.length;
            for (k = []; e--;) g = d[e], h = g.nodeName.toLowerCase(), ("source" === h || "track" === h) && k.push(g);
    ...
    function J(a, c, d) {
        a.h ? (a.aa = l, a.h.D(), a.Db && (a.Db = l, clearInterval(a.Qa)), a.Eb && K(a), a.h = l) : "Html5" !== c && a.F && (a.a.removeChild(a.F), a.F.player = j, a.F = j);
        a.ia = c;
        a.aa = l;
        var e = u.k.B({
            source: d,
        ...
        a.h.M(function() {
            ...
            if (!this.l.progressEvents) {
                ...
                a.Qa = setInterval(u.bind(a, function() {
                    this.u.kb < this.buffered().end(0) ? this.j("progress") :
            ...
            this.l.timeupdateEvents || (a = this.b, a.Eb = f, a.d("play", a.yc), a.d("pause", a.ya), a.h.U("timeupdate", function() {
    ...
    t.currentTime = function(a) {
        return a !== b ? (this.u.nc = a, M(this, "setCurrentTime", a), this.Eb && this.j("timeupdate"), this) : this.u.currentTime = L(this, "currentTime") || 0
    };
    t.duration = function(a) {
        return a !== b ? (this.u.duration = parseFloat(a), this) : this.u.duration
    };
    t.buffered = function() {
    ...
    t.volume = function(a) {
        if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.u.volume = a, M(this, "setVolume", a), u.qd(a), this;
    ...
    t.xa = function() {
        ...
        })), this.a[a.sc]()) : this.h.Sa() ? M(this, "enterFullScreen") : (this.Zc = f, this.Uc = document.documentElement.style.overflow, u.d(document, "keydown", u.bind(this, this.hc)), document.documentElement.style.overflow = "hidden", u.m(document.body, "vjs-full-window"), this.j("enterFullWindow"), this.j("fullscreenchange"));
        return this
    };
    t.nb = function() {
        var a = u.Nb.xa;
    ...
    t.src = function(a) {
        if (a instanceof Array) {
            ...
            c ? (a = c.source, c = c.h, c == this.ia ? this.src(a) : J(this, c, a)) : this.a.appendChild(u.e("p", {
                innerHTML: this.options().notSupportedMessage
            }))
        } else a instanceof Object ? window.videojs[this.ia].canPlaySource(a) ? this.src(a.src) : this.src([a]) : (this.u.src = a, this.aa ?
            (M(this, "src", a), "auto" == this.g.preload && this.load(), this.g.autoplay && this.play()) : this.M(function() {
                this.src(a)
            }));
        return this
    };
    ...
    t.Pa = function(a) {
        return a !== b ? (M(this, "setPreload", a), this.g.preload = a, this) : L(this, "preload")
    };
    t.autoplay = function(a) {
        return a !== b ? (M(this, "setAutoplay", a), this.g.autoplay = a, this) : L(this, "autoplay")
    };
    t.loop = function(a) {
        return a !== b ? (M(this, "setLoop", a), this.g.loop = a, this) : L(this, "loop")
    };
    t.poster = function(a) {
        a !== b && (this.pc = a);
        return this.pc
    ...
    t.controls = function(a) {
        return a !== b ? (a = !!a, this.rb !== a && ((this.rb = a) ? (this.t("vjs-controls-disabled"), this.m("vjs-controls-enabled"), this.j("controlsenabled")) : (this.t("vjs-controls-enabled"), this.m("vjs-controls-disabled"), this.j("controlsdisabled"))), this) : this.rb
    };
    u.w.prototype.Qb;
    t = u.w.prototype;
    t.Pb = function(a) {
        return a !== b ? (a = !!a, this.Qb !== a && ((this.Qb = a) ? (this.m("vjs-using-native-controls"), this.j("usingnativecontrols")) : (this.t("vjs-using-native-controls"), this.j("usingcustomcontrols"))), this) : this.Qb
    };
    t.error = function() {
        return L(this, "error")
    };
    ...
    function I(a, c) {
        return c !== b ? (c = !!c, c !== a.Ob && ((a.Ob = c) ? (a.ja = f, a.t("vjs-user-inactive"), a.m("vjs-user-active"), a.j("useractive")) : (a.ja = l, a.h.U("mousemove", function(a) {
            a.stopPropagation();
            a.preventDefault()
        }), a.t("vjs-user-active"), a.m("vjs-user-inactive"), a.j("userinactive"))), a) : a.Ob
    }
    var O, P, Q;
    ...
    u.Xa.prototype.Ba = function() {
        ...
        this.content.innerHTML = '<span class="vjs-control-text">Current Time </span>' + u.Ka(a, this.b.duration())
    };
    u.Ya = u.c.extend({
        i: function(a, c) {
            u.c.call(this, a, c);
    ...
    u.Ya.prototype.Ba = function() {
        ...
        a && (this.content.innerHTML = '<span class="vjs-control-text">Duration Time </span>' + u.Ka(a))
    };
    u.$b = u.c.extend({
        i: function(a, c) {
            u.c.call(this, a, c)
    ...
    t.xb = function() {
        var a;
        "Flash" === this.b.ia && this.b.seeking() ? (a = this.b.u, a = a.nc ? a.nc : this.b.currentTime()) : a = this.b.currentTime();
    ...
    u.hb = u.c.extend({
        i: function(a, c) {
            ...
            a.d("loadstart", u.bind(this, function() {
                a.h.l && a.h.l.volumeControl === l ? this.m("vjs-hidden") : this.t("vjs-hidden")
            }))
        }
    });
    u.hb.prototype.g = {
            ...
            a = function() {
                if (e.controls() && !e.Pb()) {
                    ...
                    g.d("touchend", function() {
                        s === f && (n = (new Date).getTime() - d, 250 > n && this.j("tap"))
                    });
                    g.d("tap", g.jd)
                }
            };
    ...
    u.r.prototype.p = function(a) {
        0 === a.button && this.L().controls() && (this.L().paused() ? this.L().play() : this.L().pause())
    };
    ...
    u.o = u.r.extend({
        i: function(a, c, d) {
            ...
            u.r.call(this, a, c, d);
            (c = c.source) && this.a.currentSrc == c.src ? a.j("loadstart") : c && (this.a.src = c.src);
            ...
            for (a = u.o.Za.length - 1; 0 <= a; a--) u.d(this.a, u.o.Za[a], u.bind(this.b, this.Wc));
            this.Ta()
        }
    });
    t = u.o.prototype;
    ...
    t.e = function() {
        var a = this.b,
            c = a.F;
        if (!c || this.l.movingMediaElementInDOM === l) c ? (c.player = j, a.F = j, a.v().removeChild(c), c = c.cloneNode(l)) : c = u.e("video", {
            id: a.id() + "_html5_api",
            className: "vjs-tech"
        }), c.player = a, u.yb(c, a.v());
    ...
    u.Jc && (document.createElement("video").constructor.prototype.canPlayType = function(a) {
    ...
    u.f = u.r.extend({
        i: function(a, c, d) {
            ...
            e && (e.type && u.f.ad(e.type) ?
                (a = u.f.wc(e.src), k.rtmpConnection = encodeURIComponent(a.qb), k.rtmpStream = encodeURIComponent(a.Mb)) : k.src = encodeURIComponent(u.ic(e.src)));
            u.yb(g, d);
    ...
    t.src = function(a) {
        u.f.$c(a) ? (a = u.f.wc(a), this.Nd(a.qb), this.Od(a.Mb)) : (a = u.ic(a), this.a.vjs_src(a));
        if (this.b.autoplay()) {
            var c = this;
            setTimeout(function() {
                c.play()
    ...
    function X(a, c, d) {
        for (var e = a.za, g = 0, h = e.length, k, r; g < h; g++) k = e[g], k.id() === c ? (k.show(), r = k) : d && (k.K() == d && 0 < k.mode()) && k.disable();
        ...
        if (0 < this.fa.length) {
            ...
            if (this.Kb === b || a < this.Kb || this.La <= a) {
                var c = this.fa,
                    ...
                    h = [],
                    k, r, n, s;
                a >= this.La || this.La === b ? s = this.vb !== b ? this.vb : 0 : (g = f, s = this.Cb !== b ? this.Cb : c.length - 1);
                for (;;) {
                    n = c[s];
                    if (n.ua <= a) e = Math.max(e, n.ua), n.Ha && (n.Ha = l);
                    else if (a < n.startTime) {
                        if (d = Math.min(d, n.startTime), n.Ha && (n.Ha = l), !g) break
                    } else g ? (h.splice(0, 0, n), r === b && (r = s), k = s) : (h.push(n), k === b && (k = s), r = s), d = Math.min(d, n.ua), e = Math.max(e, n.startTime),
                        n.Ha = f;
                    if (g)
                        if (0 === s) break;
                        else s--;
    ...
    u.ab.prototype.update = function() {
        for (var a = W(this.b), c = 0, d = a.length, e, g = f; c < d; c++) e = a[c], e.K() == this.ca.K() && 2 == e.mode() && (g = l);
        this.selected(g)
    };
    u.S = u.R.extend({
        i: function(a, c) {
    ...
    u.S.prototype.sa = function() {
        var a = [],
            c;
        a.push(new u.ab(this.b, {
            kind: this.A
        }));
        for (var d = 0; d < W(this.b).length; d++) c = W(this.b)[d], c.K() === this.A && a.push(new u.Y(this.b, {
            track: c
        }));
        return a
    };
    ...
    t.sa = function() {
        for (var a = [], c, d = 0; d < W(this.b).length; d++) c = W(this.b)[d], c.K() === this.A && a.push(new u.Y(this.b, {
            track: c
        }));
        return a
    };
    t.Ja = function() {
        for (var a = W(this.b), c = 0, d = a.length, e, g, h = this.J = []; c < d; c++)
        ...
        if (g) {
            e = g.fa;
            for (var k, c = 0, d = e.length; c < d; c++) k = e[c], k = new u.Wa(this.b, {
                track: g,
                cue: k
            }), h.push(k), a.Z(k)
        }
    ...
    u.cc = function() {
        ...
        if (d && 0 < d.length)
            for (var e = 0, g = d.length; e < g; e++)
                if ((c = d[e]) && c.getAttribute) c.player === b && (a = c.getAttribute("data-setup"), a !== j && (a = u.JSON.parse(a || "{}"), v(c, a)));
                else {
                    u.jb();
                    break
                }
